...
<body>
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand" href="{{ route('products.index') }}">PRODUCT MANAGEMNT</a>
                <a class="navbar-brand" href="{{ route('packages.index') }}">PACKAGING MANAGEMET</a>
            </div>
    ...
    <div class="container">
        ...
        <form action="{{ route('packages.store') }}" method="POST" class="ms-auto me-auto mt-3" style="width: 1000px"
            ...
            {{-- <select name="product_list[]" id="test">
                ...
                <div id="itemForm">
                    @foreach ($products as $pr)
                        <div class="item">
                            ...
                            <input name="product_list[]" type="checkbox" value="{{ $pr->id }}">
                        </div>
                        @endforeach
                    </div>
                </div>
