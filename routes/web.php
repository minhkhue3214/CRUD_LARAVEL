...
Route::get('user-form',[AuthController::class,"registerFormUser"])->name('form.user');
Route::post('user-register',[AuthController::class,"userRegister"])->name('register.user');

Route::get('admin-form',[AuthController::class,"registerFormAdmin"])->name('form.admin');
Route::post('admin-register',[AuthController::class,"adminRegister"])->name('register.admin');
